...
На prdx.so можно играть одному, но общение с игроками — это самая интересная часть сервера. Поэтому мы рекомендуем вступить или создать общину

<img src="https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/communes.png?raw=true" style="width: 512px">

**Выберите общину, чтобы вступить в неё:** [prdx.so/teams](https://prdx.so/teams/)

**Как создать общину:** [prdx.so/wiki/commune](https://prdx.so/wiki/commune/)
...
<img src="https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/nonrp.png?raw=true" style="width: 360px">

<img src="https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/rp.png?raw=true" style="width: 360px">
...
<img src="https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/nonrp.png?raw=true" style="width: 512px">
...
<img src="https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/rp.png?raw=true" style="width: 512px">
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/ch.png?raw=true)
...
```
НонРП персонаж говорит: "Вентерок лох".
Вентерок это не РП персонаж, его не существует в РП мире, поэтому у РП персонажа это вызовет недоумение: "Извините, а кто такой Вентерок?"
```
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/hub.png?raw=true)

## Плагин на метки

Чтобы вам не приходилось запоминать координаты всех порталов в аду — на сервере стоит самописный плагин на метки

![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/marx_info.png?raw=true)

## Меню меток

Напишите команду `/x` или `/marx` , чтобы открыть меню плагина на метки

![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/marx.png?raw=true)
...
Вы можете искать метки на [нашем сайте](prdx.so/map/). Например, если вам нужен портал в энд, то напишите в поиск `"Энд"`

![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/marx_site.png?raw=true)

Вы найдете все энд порталы, и сможете выбрать ближайший к вам

**Ищите метки тут:** [prdx.so/map](https://prdx.so/map/)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/map_nether.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/loc.png?raw=true)
...
**Мессенджер можно найти тут:** [prdx.so/im](https://prdx.so/im/), он доступен только тем, у кого есть проходка
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/messenger.jpg?raw=true)
...
**Посмотреть карту можно тут:** [prdx.so/map](https://prdx.so/map)

![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/map.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/voice.png?raw=true)
...
**Узнать больше и скачать мод:** [prdx.so/wiki/mods](https://prdx.so/wiki/mods/)

# Мир построек и мир ферм

![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/farmworld.png?raw=true)
...
<img src="https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/nick.png?raw=true" style="width: 512px">
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/bank.gif?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/gsit.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/heads.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/features/frames.png?raw=true)
