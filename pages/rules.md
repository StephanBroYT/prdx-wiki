...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/trash_tree.png?raw=true)
  
- Не используйте блоки для того, чтобы перемещаться, или чтобы забираться на гору
  
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/trash_blocks1.png?raw=true)
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/trash_blocks2.png?raw=true)
  
- Закрывайте дырки от криперов
  
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/trash_creeper.png?raw=true)

- Не стройте столбы в один блок, убирайте их за собой
  
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/trash_pillar.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/trash_mine.png?raw=true)
  
- Не взрывайте территорию. Даже если эта территория принадлежит вам, или никому не принадлежит
  
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/trash_tnt.png?raw=true)
  
- Не делайте лавакасты
  
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/trash_lava.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/farmworld.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/highway1.png?raw=true)

### Высота веток

Ветки находятся на 69 высоте, лёд находится на 68 высоте

![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/ice_height.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/highway2.png?raw=true)
...
![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/highway3.png?raw=true)

**Правильно**

![](https://github.com/digitaldrugstech/prdx-wiki/blob/main/assets/rules/highway4.png?raw=true)
